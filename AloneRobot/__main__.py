...
🌹𝐈 𝐀𝐦 𝐓𝐡𝐞 𝐌𝐨𝐬𝐭 𝐏𝐨𝐰𝐞𝐫𝐟𝐮𝐥 𝐓𝐞𝐥𝐞𝐠𝐫𝐚𝐦 𝐆𝐫𝐨𝐮𝐩 𝐌𝐚𝐧𝐚𝐠𝐞𝐦𝐞𝐧𝐭 𝐀𝐧𝐝 𝐌𝐮𝐬𝐢𝐜 𝐒𝐭𝐫𝐞𝐚𝐦𝐢𝐧𝐠 𝐁𝐨𝐭 𝐖𝐢𝐭𝐡 𝐌𝐚𝐧𝐲 𝐅𝐚𝐧𝐭𝐚𝐬𝐭𝐢𝐜 𝐅𝐞𝐚𝐭𝐮𝐫𝐞𝐬..🌹
─────────────────
🥳𝐀𝐝𝐝 𝐌𝐞 𝐈𝐧 𝐘𝐨𝐮𝐫 𝐆𝐫𝐨𝐮𝐩𝐬 𝐓𝐨 𝐄𝐧𝐣𝐨𝐲 𝐀𝐥𝐥 𝐌𝐲 𝐅𝐞𝐚𝐭𝐮𝐫𝐞𝐬..🥳
─────────────────
💞𝐂𝐥𝐢𝐜𝐤 𝐎𝐧 𝐓𝐡𝐞 𝐁𝐮𝐭𝐭𝐨𝐧 𝐁𝐞𝐥𝐨𝐰 𝐓𝐨 𝐆𝐞𝐭 𝐈𝐧𝐟𝐨𝐫𝐦𝐚𝐭𝐢𝐨𝐧 𝐀𝐛𝐨𝐮𝐭 𝐀𝐥𝐥 𝐓𝐡𝐞 𝐌𝐨𝐝𝐮𝐥𝐞𝐬 𝐀𝐧𝐝 𝐂𝐨𝐦𝐦𝐚𝐧𝐝𝐬.. 💞
"""
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton(text="𝐁ᴀᴄᴋ⏎", callback_data="XD_BACK"),
                    ],
                ]
            ),
        )
...
""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text="𝐁ᴀᴄᴋ⏎", callback_data="Music_"),
                    ]
                ]
            ),
        )
